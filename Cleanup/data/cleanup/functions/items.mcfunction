...
execute as @a at @s run scoreboard players set @e[type=minecraft:item, distance=10..] cleanupNearby 0
execute as @a at @s run scoreboard players set @e[type=minecraft:item, distance=..10] cleanupNearby 1
